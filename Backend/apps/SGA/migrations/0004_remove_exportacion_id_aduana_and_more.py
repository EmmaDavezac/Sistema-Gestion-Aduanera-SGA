...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('SGA', '0003_remove_importacion_id_aduana_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='exportacion',
            name='aduana',
            field=models.ForeignKey(default=111, on_delete=django.db.models.deletion.PROTECT, related_name='exportaciones', to='SGA.aduana'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='exportacion',
            name='cliente',
            field=models.ForeignKey(default=20408389543, on_delete=django.db.models.deletion.CASCADE, related_name='exportaciones', to='SGA.cliente'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='exportacion',
